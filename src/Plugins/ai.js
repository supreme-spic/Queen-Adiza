...
module.exports = [{
  ...
  operate: async ({
    ...
    const statusMessage = "Adizabot " + (_0x290cb7 === "on" ? "enabled" : "disabled") + " successfully";

    const additionalMessage = _0x290cb7 === "on"
      ? "\n*Use `?` before your message to interact with the bot (e.g., ?hello).*"
      : "";
  ...
  operate: async ({
    ...
    _0x1a260f("Natashabot " + (_0x290cb7 === "on" ? "enabled" : "disabled") + " successfully");
  }
}];