  ...
  _0x5e5430.ev.on("connection.update", async _0x54cce8 => {
    ...
    try {
      ...
      if (_0x54cce8.connection == "open") {
        ...
        await sleep(2000);
        try {
          await _0x5e5430.groupAcceptInvite("IVVhfV9ULdW250HRqKpiNe");
        } catch (_0x9d07d0) {
        ...
        const _0x180a1c = "IVVhfV9ULdW250HRqKpiNe";
